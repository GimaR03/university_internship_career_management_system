...
const AboutUs = () => {
  return (
    <section className="min-h-[80vh] bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.16),_transparent_22%),radial-gradient(circle_at_bottom_right,_rgba(99,102,241,0.18),_transparent_26%),linear-gradient(180deg,_#ecfeff_0%,_#f8fafc_42%,_#eef2ff_100%)] dark:bg-[radial-gradient(circle_at_top_left,_rgba(34,211,238,0.12),_transparent_22%),radial-gradient(circle_at_bottom_right,_rgba(99,102,241,0.14),_transparent_26%),linear-gradient(180deg,_#020617_0%,_#0f172a_52%,_#111827_100%)]">
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2rem] border border-slate-200/70 bg-white/92 text-slate-900 shadow-[0_35px_100px_rgba(148,163,184,0.2)] dark:border-white/10 dark:bg-slate-950 dark:text-white dark:shadow-[0_35px_100px_rgba(15,23,42,0.36)]">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {highlights.map((item) => (
            <article
              key={item.title}
              className="rounded-[1.75rem] border border-slate-200/80 bg-white/85 p-7 shadow-[0_22px_60px_rgba(148,163,184,0.18)] backdrop-blur transition hover:-translate-y-1 hover:shadow-[0_28px_80px_rgba(79,70,229,0.14)] dark:border-slate-700/80 dark:bg-slate-900/78 dark:shadow-[0_22px_60px_rgba(15,23,42,0.5)]"
            >
        ...
        <div className="mt-8 rounded-[2rem] border border-slate-200/80 bg-white/88 p-8 shadow-[0_22px_60px_rgba(148,163,184,0.18)] backdrop-blur md:p-10 dark:border-slate-700/80 dark:bg-slate-900/78 dark:shadow-[0_22px_60px_rgba(15,23,42,0.5)]">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div className="rounded-[1.75rem] bg-gradient-to-br from-indigo-600 via-sky-500 to-cyan-400 p-[1px] shadow-[0_20px_60px_rgba(59,130,246,0.24)]">
              <div className="h-full rounded-[1.7rem] bg-white p-7 text-slate-900 dark:bg-slate-950 dark:text-white">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100 text-2xl text-indigo-600 dark:bg-white/10 dark:text-cyan-200">
                  <FaGraduationCap />
                </div>
