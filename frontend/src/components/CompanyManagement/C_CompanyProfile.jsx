                ...
                <div className="px-8 pt-8 pb-6 border-b dark:border-slate-800 flex justify-between items-center">
                    ...
                    {!isEditing && (
                        <button
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-2xl transition-all duration-200 flex items-center gap-2 shadow-lg shadow-indigo-500/30"
                        >
                            ...
                            {isEditing && (
                                <div className="flex space-x-3 pt-4">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 transition-all font-medium shadow-lg shadow-indigo-500/20"
                                    >
