...
export const getAdminNavigation = (role) => {
  const items = [
    { label: 'Dashboard', path: '/admin/dashboard', accessKey: 'dashboard' },
    { label: 'Create Admin', path: '/admin/create', accessKey: 'createAdmin' },
    { label: 'Admin Registry', path: '/admin/registry', accessKey: 'adminRegistry' },
    { label: 'Company Data', path: '/admin/companies', accessKey: 'companies' },
    { label: 'Internship Data', path: '/admin/internships', accessKey: 'internships' },
    { label: 'Payment Data', path: '/admin/payments', accessKey: 'payments' },
  ];
